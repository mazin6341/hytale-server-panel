<div x-data="{ mobileMenuOpen: false }" class="flex h-screen overflow-hidden dark:bg-gradient-to-bl dark:from-gray-950 dark:to-gray-900 dark:text-gray-100 bg-gradient-to-bl from-gray-50 to-gray-100 text-gray-900">
