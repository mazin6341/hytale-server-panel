...
class WebMap extends Component
{
    ...
    public function mount() {
        $this->settings = AppSetting::where('section', 'Web Map')->get()->map(fn($setting) => ['name' => $setting->name, 'value' => $setting->getValue(), 'is_encrypted' => $setting->is_encrypted, 'is_boolean' => $setting->is_boolean])->toArray();
    }
